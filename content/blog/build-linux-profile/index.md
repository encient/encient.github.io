---
title: "Build a Linux Profile for Volatility 2"
description: "Step-by-step guide on building an Ubuntu profile for Volatility 2 and fixing the errors."
...
- [Why Create Profile?](#why-create-profile)
- [Start Building](#start-building)
    - [Configuring Virtual Machine](#configuring-virtual-machine)
        - [Error: Original kernel is more up-to-date](#error-original-kernel-is-more-up-to-date)
    - [Build Profile](#build-profile)
        - [Error: Missing MODULE_LICENSE()](#error-missing-module_license)
    - [Add Profile into Volatility 2](#add-profile-into-volatility-2)
- [Move Profile to Own Machine](#move-profile-to-own-machine)
    - [KeyError: ‘DW_AT_data_member_location’](#keyerror-dw_at_data_member_location)
...
To build a new Volatility 2 profile:
...
![Check Linux Image](Untitled2.png)
...
![Edit GRUB Menu Configuration](Untitled3.png)
...
![Advanced Option](Untitled4.png)

Once GRUB menu loaded, choose `Advanced options for Ubuntu`.

![Select Kernel](Untitled5.png)
...
![Missing MODULE_LICENSE](Untitled6.png)
...
![Success Output of Make Command](Untitled7.png)
...
![Verify Profile Built](Untitled9.png)
...
![KeyError: ‘DW_AT_data_member_location’](Untitled12.png)
